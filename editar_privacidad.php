...
<head>
    <title>¿Perfil privado? - Click</title>
    <meta charset="UTF-8">
        ...
        <div class="e-mid">
            ...
            <form action="" method="post">
                ...
                if (isset($_POST['editar'])) {
                    ...
                    if ($update) {
                        header("Location: editar_privacidad.php");
                    }
                }
                ?>
                    ...
                    <div class="e-contenido">
                        ...
                        <div class="e-but">
                            <input type="submit" value="Editar" name="editar" class="button_blue"
                                style="margin-left: 230px; margin-bottom: 30px; color: white; font-size: 16px; padding:6px 9px;font-weight: 600;">
                        </div>
                    </div>
