...
<body>
    ...
    $sqlA = $mysqli->query("SELECT * FROM publicaciones WHERE status_pub != 'exclusivo' AND categoria_pub = 'musica' AND estado = 'normal' ORDER BY id DESC");
