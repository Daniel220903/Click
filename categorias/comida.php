...
<body>
    ...
    $sqlA = $mysqli->query("SELECT * FROM publicaciones WHERE status_pub != 'exclusivo' AND categoria_pub = 'comida' AND estado = 'normal' ORDER BY id DESC");
