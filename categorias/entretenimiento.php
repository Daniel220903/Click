...
<head>
    ...
    <title>Entretenimiento - Click</title>
...
<body>
    ...
    $sqlA = $mysqli->query("SELECT * FROM publicaciones WHERE status_pub != 'exclusivo' AND categoria_pub = 'entretenimiento' AND estado = 'normal' ORDER BY id DESC");
